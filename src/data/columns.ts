  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        '陸のセルは数えません。EEZは基線から測りますが、生まれるのは海の権利であって、陸地がEEZになるわけではないからです。地図に描いているのと同じ海岸線データで陸を判定し、面積から外しています。',
      ],
    },
    {
      heading: '中間線は、中立ではない',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '係争海域を除いた場合: 実データ(Marine Regions)は 406.7万km²、自前計算は 412.1万km²。',
        'すべて日本に算入した場合: 実データは 443.8万km²、自前計算は 445.7万km²。',
        ...
        'このアプリの既定は「係争中」です。北方領土・竹島・尖閣の周辺は、どの国の面積にも算入せず、灰色の斜線で描きます。3つとも日本に割り当てると 33.6万km² 増えて 445.7万km² になります(内訳は北方領土 20.4万km²、尖閣 6.9万km²、竹島 6.3万km²)。相手国に割り当てても、日本の面積は既定から1km²も動きません(もともと入っていないからです)。',
        '同じ「日本のEEZ」という言葉が、誰がどの立場で数えるかで34万km²動く。この幅そのものが、この問題の性質をよく表しています。',
      ],
    },
    {
      heading: '実データとの差は、1.3%',
      paragraphs: [
        '実データ表示は Marine Regions の 406.7万km²。シミュレーションに切り替えると、係争中のままで 412.1万km² になります。差は 5.4万km²、1.3%。係争地がこっそり日本のものにされているわけではありません(相手国に割り当てても同じ 412.1万km² です)。',
        'この1.3%は計算モデルの違いです。向きの違う誤差が同時に働いています。竹島や尖閣のような小さな島にも完全な効果(200海里)を与えているため、このアプリの竹島周辺には 6.3万km² の係争海域が生まれます ―― Marine Regions が切り出しているのは 0.16万km² だけです。この分は日本の取り分を減らす向きに働きます。逆に、日韓暫定水域(8.3万km²)のような共同管理の概念がこのアプリにはなく、中間線で機械的に割ってしまうので、こちらは増やす向きに働きます。',
        'ほかに、実際の直線基線ではなく海岸線から10km間隔で点を取っていること、4.4kmのセルで数えていることが積み重なります。差し引きで 1.3% です。個々の寄与を厳密に切り分けることはできません。',
      ],
    },
    {
      heading: 'モデルは近似である',
      paragraphs: [
        '係争海域をすべて日本に算入した場合の自前計算は 445.7万km² で、公称値(約447万km²)の99.7%になります。よく一致していますが、これは上に書いた向きの違う誤差が打ち消し合った結果でもあります。一致したから正しい、とは考えないでください。',
