...
const METHOD: Column = {
  ...
  sections: [
    ...
    {
      heading: '「日本のEEZ」は、誰が数えるかで40万km²動く',
      paragraphs: [
        'このアプリには日本のEEZ面積が2つ出てきます。実データ表示の 406.7万km² と、自前計算の 475.2万km²。日本政府の公称値は 447万km²。三者とも違います。理由は、どれも数え方が違うからです。',
        '実データの Marine Regions は、争いのある海域を日本のEEZから切り出して別のポリゴンにしています。北方領土周辺 21.4万km²、尖閣諸島周辺 7.4万km²、日韓暫定水域 8.3万km²、竹島周辺 0.16万km²。合計 37.2万km²です。',
        'これらを足し戻すと 443.8万km² になり、日本の公称値 447万km² の 99.3% と一致します。つまり実データの数字は「日本が主張しているが、他国も主張している海域を含まない」EEZです。領海を含む・含まないの違いではありません(Marine Regionsのポリゴンは領海を含みます)。',
        '自前計算の 475.2万km² が公称値より 28万km² 多いのは、係争海域をすべて日本に算入し、日韓暫定水域も中間線で機械的に割り、小さな島にも完全な効果を与えているからです。',
        '同じ「日本のEEZ」という言葉が、誰がどの立場で数えるかで40万km²動く。この幅そのものが、この問題の性質をよく表しています。',
      ],
    },
    {
      heading: 'モデルは近似である',
