  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'このアプリの既定は「係争中」です。北方領土・竹島・尖閣の周辺は、どの国の面積にも算入せず、灰色の斜線で描きます。3つとも日本に割り当てると 34.1万km² 増えて 475.2万km²、公称値の106%になります。相手国に割り当てても、日本の面積は既定から1km²も動きません(もともと入っていないからです)。',
        '同じ「日本のEEZ」という言葉が、誰がどの立場で数えるかで34万km²動く。この幅そのものが、この問題の性質をよく表しています。',
      ],
    },
    {
      heading: '実データを触ってから島を動かすと、数字が34万km²跳ねる',
      paragraphs: [
        '起動直後に見える 406.7万km² は Marine Regions の実データ。島を1mmでも動かすと自前計算に切り替わり、係争中のままでも 441.1万km² になります。係争地がこっそり日本のものにされたわけではありません(相手国に割り当てても同じ 441.1万km² です)。差の 34.5万km²、8.5% は、まるごと計算モデルの違いです。',
