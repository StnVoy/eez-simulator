  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '係争海域を除いた場合: 実データ(Marine Regions)は 406.7万km²、自前計算は 441.1万km²。',
        'すべて日本に算入した場合: 実データは 443.8万km²、自前計算は 475.2万km²。',
        ...
        'このアプリの既定は「係争中」です。北方領土・竹島・尖閣の周辺は、どの国の面積にも算入せず、灰色の斜線で描きます。3つとも日本に割り当てると 34.1万km² 増えて 475.2万km²、公称値の106%になります。',
    ...
    },
    {
      heading: 'モデルは近似である',
      paragraphs: [
        '係争海域をすべて日本に算入した場合の自前計算は約475万km²で、公称値(約447万km²)の約106%になります。漁業協定線や未画定海域、実際の直線基線を再現していないためです。',
